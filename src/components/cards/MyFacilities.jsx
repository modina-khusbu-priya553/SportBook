    ...
    <Card className="shadow-md hover:shadow-xl transition-shadow duration-300 
      ...
      <div className="flex flex-col justify-between gap-3">
       <div className="space-y-1">
        ...
        <span className="flex items-center gap-2 text-sm md:text-md text-gray-600">
          <LuBadgeDollarSign />
          <p className="text-sm md:text-md text-gray-500">Price:</p>
          <p className=" font-semibold text-[#22C55E]">${price_per_hour}/hr</p>
        </span>
        ...
        {available_slots?.length > 0 && (
          <div className="flex flex-col gap-1.5 pt-1">
            ...
            <div className="flex items-center gap-4">
                <EditFacilityModal facilities={facilities}></EditFacilityModal>
