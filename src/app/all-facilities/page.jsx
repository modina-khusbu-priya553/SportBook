        ...
        <div className="bg-[#F7F7F2]">
            <div className="container mx-auto py-20 px-10">
                <div className="flex flex-col items-center gap-8 justify-center text-center">
                    <h2 className="text-xl md:text-5xl font-bold">Discover Our Sports Facilities</h2>
                    <p className="text-muted text-xl">Explore premium sports venues and book your favorite
                        facility in just a few clicks.
                    </p>
                </div>
                <div className="flex items-center gap-8 justify-center flex-col md:flex-row py-8">
                    <SearchField name="primary-search" variant="primary" className="w-full md:w-1/2">
                        <SearchField.Group className="p-5">
                        <SearchField.SearchIcon className="text-xl font-semibold"/>
                        <SearchField.Input className="text-xl font-semibold" placeholder="Search Facility..." />
                        <SearchField.ClearButton />
                        </SearchField.Group>
                    </SearchField>
                    <div>
                        <Select className="w-[256px] hover: text-lg" placeholder="All sports" variant="primary">
